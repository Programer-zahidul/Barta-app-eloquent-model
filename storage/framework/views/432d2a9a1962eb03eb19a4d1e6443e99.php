...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('people'),'active' => request()->routeIs('people')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('people')),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('people'))]); ?>
            <?php echo e(__('People')); ?>
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
           <?php $__env->slot('trigger', null, []); ?> 
            <button data-tooltip-target="tooltip-bottom" data-tooltip-placement="bottom" type="button"
              ...
              <img class="h-8 w-8 rounded-full" src="<?php echo e(asset($currentUser->img)); ?>" alt="<?php echo e($currentUser->img); ?>" />
            </button>
            <div id="tooltip-bottom" role="tooltip"
              class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
              <?php echo e(ucwords($currentUser->fname . ' ' . $currentUser->lname)); ?>
...
<?php /**PATH E:\Workspaces\Laravel Project\Practice\Barta-app\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>